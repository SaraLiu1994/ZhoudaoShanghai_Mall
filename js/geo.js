...
function preselect(p_key) {
    ...
    var provinces = new Array("北京市", "天津市", "上海市", "重庆市", "河北省", "山西省", "内蒙古", "辽宁省", "吉林省", "黑龙江省", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省", "湖南省", "广东省", "广西", "海南省", "四川省", "贵州省", "云南省", "西藏", "陕西省", "甘肃省", "青海省", "宁夏", "新疆", "香港", "澳门", "台湾省","省份/自治区");
...
var s = ["province-pick", "shi-pick", "xian-pick"];
var opt0 = ["省份/自治区", "请选择", "请选择"];
function setup() {
